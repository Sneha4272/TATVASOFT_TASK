    ...
    public class JwtService
    {
        ...
        public string GenerateJwtToken(UserLoginResponseModel loginUser)
        {
            ...
            var payload = new[]
            {
                ...
                new Claim("fullName", $"{loginUser.FName} {loginUser.LName}"),
                new Claim("firstName", loginUser.FName),
                new Claim("lastName", loginUser.LName),
                new Claim("emailAddress", loginUser.EmailID),
